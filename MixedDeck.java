...
public class MixedDeck extends RandomBag<String> {
    private RandomBag<String> mixedDeck = RandomBag.RandomBag();
    ...
    private void makeDeck(){
        ...
        for (int i = 0; i < deck.length; i++) {
            mixedDeck.add(deck[i]);
        }
    }
    public String getCard() {
        Iterator<String> iterator = mixedDeck.iterator();
